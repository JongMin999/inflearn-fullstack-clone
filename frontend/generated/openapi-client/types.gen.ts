...
export type CoursesControllerFindMyCoursesData = {
    body?: never;
    path?: never;
    query?: never;
...
export type CoursesControllerFindMyCoursesResponses = {
    /**
     * 강사 본인의 코스 목록
     */
    200: Array<Course>;
...
export type CoursesControllerFindMyCoursesResponse = CoursesControllerFindMyCoursesResponses[keyof CoursesControllerFindMyCoursesResponses];
...
export type CoursesControllerUnenrollCourseData = {
    body?: never;
    path: {
        id: string;
    };
...
export type CoursesControllerUnenrollCourseResponses = {
    /**
     * 수강취소
     */
    200: boolean;
...
export type CoursesControllerUnenrollCourseResponse = CoursesControllerUnenrollCourseResponses[keyof CoursesControllerUnenrollCourseResponses];
