          ...
          <div>
            ...
            {instructorStats && (
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground mt-4">
                <span>
                  수강생 {instructorStats.totalStudents.toLocaleString()}명
                </span>
                <span>수강평 {instructorStats.totalReviews}개</span>
                <span>답변 {instructorStats.totalAnswers}개</span>
                <span>강의 {instructorStats.totalCourses}개</span>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="mt-12 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10">
        ...
        <div className="max-w-3xl">
          ...
          <InstructorBio 
            ...
            instructorStats={(course as any).instructorStats}
          />
